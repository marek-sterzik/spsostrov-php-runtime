 ...
 */
final class Version20250503204534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assignment (id INT AUTO_INCREMENT NOT NULL, caption VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, classes VARCHAR(255) NOT NULL, school_year INT DEFAULT NULL, public TINYINT(1) NOT NULL, state VARCHAR(255) DEFAULT NULL, soft_deadline DATETIME DEFAULT NULL, hard_deadline DATETIME DEFAULT NULL, owner_id INT NOT NULL, INDEX IDX_30C544BA7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
