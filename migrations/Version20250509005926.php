 ...
 */
final class Version20250509005926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE submission (id INT AUTO_INCREMENT NOT NULL, uuid CHAR(36) NOT NULL, state VARCHAR(16) NOT NULL, created_at DATETIME NOT NULL, submitted_at DATETIME DEFAULT NULL, assignment_id INT NOT NULL, submitter_id INT NOT NULL, INDEX IDX_DB055AF3D19302F8 (assignment_id), INDEX IDX_DB055AF3919E5513 (submitter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
